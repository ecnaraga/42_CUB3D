...
/*   Updated: 2024/05/17 15:27:16 by galambey         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../../includes/cub3d.h"

void	check_char_bis(char *str, int *i, int *player, t_cub *cub)
{
...
char	*check_char(char *str, t_cub *cub)
{
	...
	while (str[i])
	{
		check_char_bis(str, &i, &player, cub);
		if (!ft_strchr(ALLOWD_CHAR_B, str[i]))
